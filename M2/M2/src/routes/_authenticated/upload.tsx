      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Paste a link to your training or movement clip — from any site — for pose estimation and biomechanical analysis. Your uploads are private and only visible to your assigned staff.
          </p>
        </div>
      </div>
