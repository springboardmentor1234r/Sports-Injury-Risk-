...
from app.routers import auth, athletes, injuries, performance, assessments, training_load, videos, risk_assessments
...
app = FastAPI(
    ...
    description="Milestone 3: Auth, Athlete Profile Management, Pose Estimation, Biomechanical Analysis, and Injury Risk Scoring",
    version="0.4.0",
)
