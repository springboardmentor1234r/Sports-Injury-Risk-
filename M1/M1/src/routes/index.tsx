      ...
      <section id="features" className="mx-auto max-w-7xl px-6 py-24">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-4xl font-bold">
            A full injury-intelligence stack.
          </h2>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <div
              key={f.title}
              className="group rounded-2xl border border-border bg-card p-6 shadow-card transition hover:border-primary/50"
            >
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-4">
            {[
              [
                ...
                "Capture sport, position, injury history and training load.",
              ],
              [
                "02",
                "Upload video",
                "Any device. Running, jumping, cutting, sport-specific drills.",
              ],
              [
                "03",
                "AI analyzes movement",
                "Pose estimation + biomechanical metrics + risk model.",
              ],
              [
                "04",
                "Act on insights",
                "Risk score, dashboards and corrective programs delivered.",
              ],
            ].map(([n, t, d]) => (
        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          <div>
            <h2 className="font-display text-4xl font-bold">
              Built for every role in performance.
            </h2>
            <p className="mt-4 text-muted-foreground">
