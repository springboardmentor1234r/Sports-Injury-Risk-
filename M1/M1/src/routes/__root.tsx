...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "KinetIQ — AI Sports Injury Risk Detection from Video" },
      {
      ...
      { name: "twitter:title", content: "KinetIQ — AI Sports Injury Risk Detection from Video" },
      {
