...
export default function AthleteDetail() {
  ...
  if (avg_trunk_lean > 20) {
    riskLevel = "High";
    reasons.push(`Trunk lean is too high (${avg_trunk_lean}°) — adjust posture`);
  ...
  if (knee_valgus_asymmetry > 5) {
    riskLevel = "High";
    reasons.push("Knee valgus asymmetry is high — change landing angle");
  }

  if (reasons.length === 0) {
    reasons.push("Form looks good — knee angles, trunk lean, and symmetry are all within safe range");
  }
