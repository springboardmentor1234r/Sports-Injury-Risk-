# Sports Injury Risk Detection (SIRD) System 🏃‍♂️⚡

> **AI-Powered Biomechanical Motion Analysis & Real-Time Injury Risk Prevention Platform**

---

## 📌 Project Overview

The **Sports Injury Risk Detection (SIRD) System** is an end-to-end computer vision and machine learning platform designed to assess athlete movement mechanics, detect high-risk biomechanical anomalies, and provide personalized clinical rehabilitation prescriptions in real time.
...
* **📹 Real-Time Live Motion Capture Modal**:
  ...
  * Overlays **Glowing Red Joint Nodes** (*Shoulders, Elbows, Wrists, Hips, Knees, Ankles*) connected by **Vibrant Yellow Bone Lines**.
  * Records live motion events (`REC 00:05`) and automatically submits clips for full MediaPipe + ML analysis.
...
JWT_SECRET_KEY=c0fda31c14076334b731ec543c60d641192f12cefd1d31870de82b229748bf92
