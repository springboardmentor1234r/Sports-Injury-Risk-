...
- Database: PostgreSQL
- AI/CV: OpenCV, MediaPipe (from Milestone 2 onward)

## Milestones
- M1: Setup, auth, athlete profiles, dataset prep
- M2: Pose estimation
- M3: Injury prediction & recommendations
- M4: Dashboards, testing, deployment
EOF