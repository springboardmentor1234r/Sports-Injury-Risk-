...
function UploadVideo() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (!isLikelyUrl(videoUrl)) {
      return toast.error(
        "Enter a valid video link (any site — YouTube, Vimeo, Drive, a direct .mp4 link, etc.).",
      );
    }
    setBusy(true);
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Paste a link to your training or movement clip — from any site — for pose estimation and
            injury-risk analysis. Your uploads are private and only visible to your assigned staff.
          </p>
        </div>
      </div>
      ...
      >
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="e.g. Sprint session — 12 July"
            maxLength={120}
          />
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="Anything relevant — drill, context, how you're feeling…"
            maxLength={2000}
          />
        </div>
