  ...
  public: {
    Tables: {
      alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "alerts_athlete_user_id_fkey";
          ...
          {
            foreignKeyName: "alerts_video_submission_id_fkey";
      ...
      athlete_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "athlete_profiles_coach_user_id_fkey";
    ...
    Functions: {
      can_access_athlete_row: {
        Args: { _athlete_user_id: string; _coach_user_id: string };
        Returns: boolean;
      };
      can_access_athlete_user: {
        Args: { _athlete_user_id: string };
        Returns: boolean;
      };
      has_role: {
        Args: {
      ...
      is_org_wide: { Args: { _user_id: string }; Returns: boolean };
    ...
    Enums: {
      app_role: "athlete" | "coach" | "physiotherapist" | "sports_scientist" | "administrator";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
