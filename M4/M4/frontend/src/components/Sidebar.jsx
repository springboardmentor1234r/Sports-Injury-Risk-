...
const COMMON = [["/dashboard", "Overview", "grid"], ["/upload", "Analyze video", "video"], ["/analyses", "Analysis history", "activity"], ["/reports", "Reports", "report"], ["/notifications", "Alerts", "bell"], ["/profile", "My profile", "user"], ["/settings", "Settings", "settings"]];
