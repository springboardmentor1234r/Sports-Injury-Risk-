...
export default function VideoAnalysis() {
  ...
  const loadResults = async (videoId) => {
    try {
      ...
      // separately since it's allowed to be briefly unavailable if the
      // risk engine step hiccuped (biomechanics still succeeds either way).
      try {
        const riskRes = await axios.get(`${API_BASE}/videos/${videoId}/risk-assessment`, { headers });
