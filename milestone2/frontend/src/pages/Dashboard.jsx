...
import { 
  ...
  Plus, CheckCircle2, ShieldAlert, Award, FileSpreadsheet, Eye, UserCheck, RefreshCw, Cpu, UploadCloud
} from 'lucide-react';
...
export default function Dashboard({ user, token, logout, theme, toggleTheme }) {
  ...
  // Fetch latest video analysis for current active athlete
  useEffect(() => {
    if (user && token) {
                ...
                <>
                  ...
                  {activeTab === 'InjuryRisk' && (
                    <div className="content-hero-card placeholder-tab-card animate-fade-in">
                      ...
                      <p className="workspace-desc">Platform-wide risk score calculated based on your joint collapse and pelvic tilt limits.</p>
                      
                      <div className="placeholder-tab-content">
                        <div className="risk-score-circle">
                          <span className="risk-percentage">
                            {latestAnalysis ? `${latestAnalysis.scores.injury_risk_score}%` : "18%"}
                          </span>
                          <span className="risk-level">
                            {latestAnalysis && latestAnalysis.scores.injury_risk_score > 40 ? "Elevated Risk" : "Low Risk"}
                          </span>
                        </div>
                        <p className="placeholder-tab-text">
                          {latestAnalysis 
                            ? `Joint strain analysis on file "${latestAnalysis.filename}": Knee rotation collapse and loading deceleration shock profiles classified.` 
                            : "Athlete Injury Risk Score Workspace. Joint strain analysis is within optimal limits."}
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {activeTab === 'MovementAnalysis' && (
                    <div className="content-hero-card animate-fade-in">
                      ...
                      <p className="workspace-desc">Real-time biomechanical parameters computed from your latest video feed.</p>
                      ...
                      {!latestAnalysis ? (
                        ...
                        <div className="athlete-detail-view animate-scale-in">
                          ...
                          <div className="joint-angles-card">
                            <h3>Pose Estimation Landmark Outputs ({latestAnalysis.filename})</h3>
                            <div className="angles-list">
                              <div className="angle-item">
                                ...
                                <div className="angle-bar-container">
                                  <div 
                                    className={`angle-bar ${latestAnalysis.scores.injury_risk_score > 40 ? 'warning' : 'optimal'}`} 
                                    style={{ width: '82%' }}
                                  >
                              ...
                              <div className="angle-item">
                                ...
                                <div className="angle-bar-container">
                                  <div className="angle-bar optimal" style={{ width: '75%' }}>
                              ...
                              <div className="angle-item">
                                ...
                                <div className="angle-bar-container">
                                  <div 
                                    className={`angle-bar ${latestAnalysis.metrics.landing_mechanics.includes('Stiff') ? 'warning' : 'optimal'}`} 
                                    style={{ width: '65%' }}
                                  >
                              ...
                              <div className="angle-item">
                                <span className="angle-name">Stride Length</span>
                                <div className="angle-bar-container">
                                  <div className="angle-bar optimal" style={{ width: '90%' }}>
                                    {latestAnalysis.metrics.stride_length}
                                  </div>
                                </div>
                              </div>
                              <div className="angle-item">
                                <span className="angle-name">Joint Alignment</span>
                                <div className="angle-bar-container">
                                  <div className="angle-bar optimal" style={{ width: '95%' }}>
                                    {latestAnalysis.metrics.joint_alignment}
                                  </div>
                                </div>
                              </div>
                              <div className="angle-item">
                                <span className="angle-name">Balance & COM Drift</span>
                                <div className="angle-bar-container">
                  ...
                  {activeTab === 'Progress' && (
                    <div className="content-hero-card placeholder-tab-card animate-fade-in">
                      ...
                      <div className="placeholder-tab-content">
                        ...
                        <p className="placeholder-tab-text">Progress Tracking Workspace. Daily workload and rehabilitation timelines.</p>
                      </div>
                    </div>
                  )}
                  ...
                  {activeTab === 'ExerciseRecs' && (
                    <div className="content-hero-card placeholder-tab-card animate-fade-in">
                      ...
                      <div className="placeholder-tab-content">
                        ...
                        <p className="placeholder-tab-text">Exercise Recommendations Workspace. Custom conditioning programs will be displayed here.</p>
                      </div>
                    </div>
                  )}
                  ...
                  {activeTab === 'Performance' && (
                    <div className="content-hero-card placeholder-tab-card animate-fade-in">
                      ...
                      <div className="placeholder-tab-content">
                        ...
                        <p className="placeholder-tab-text">Performance Trends Workspace. Jump height and athletic velocity analytics.</p>
                      </div>
                    </div>
                  )}
